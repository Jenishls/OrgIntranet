<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Uplods.aspx.cs" Inherits="Admin_Uplods" %>
...
<asp:BoundField DataField="CreationTime" HeaderText="Date" />
    ...
    <%--<asp:CommandField HeaderText="Action" ShowHeader="True" ControlStyle-ForeColor="Blue" ShowSelectButton="True" SelectText="View"/>--%>
    ...
    <%--<asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID = "lnkDelete"  Text = "Delete" CommandArgument = '<%# Eval("CreationTime") %>' runat = "server" OnClick = "DeleteFile" />
            </ItemTemplate>
        </asp:TemplateField>--%>
