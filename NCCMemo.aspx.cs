...
public partial class NCCMemo : System.Web.UI.Page
{
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        if (btnCreate.Text == "Create")
        {
            ...
            if (i > 0)
            {
                ...
                {
                    string filext = Path.GetExtension(p.FileName);
                    ...
                    p.SaveAs(MapPath("~/MemoImage/" + referenceno + "/" + p.FileName));
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        //if (Directory.Exists(Server.MapPath("~/MemoImage/" + refno)))
        //{ 
        //vAttach.Text = "Yes";
        //}
        //else
