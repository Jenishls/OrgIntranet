<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="NCCMemo.aspx.cs" Inherits="NCCMemo" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <script>
         function printpage() {
            ...
            MainWindow.document.write('<html><head><title>Ncc Bank Ltd - NCC-Internal Memo Processing System(IMPS) </title>');
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div style="font-family:Arial">
                    ...
                    <div>
                        <table class="table">
                            <tr>
                                <td colspan="3" class="header">NCC-Internal Memo Processing System</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 200px" class="risklefttd">Attachments(PDF files Only)</td>
                                <td class="riskrighttd">
                                    <%--<asp:AjaxFileUpload ID="FileUpload1" runat="server" AllowedFileTypes="PDF"
                            ...
                            <table>
                            <tr>
                                    <td style="width: 200px" class="risklefttd" >Forward To</td>
                                <td>
                                    <asp:TextBox ID="txtForwardTo" runat="server" cssclass="textboxcss" Width="300px" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnCreate" CssClass="btnMain btnGreen" runat="server" Text="Create" OnClick="btnCreate_Click" ValidationGroup="a" />
                        ...
                        <br />
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                         <asp:GridView ID="gvFiles" CellPadding="4" runat="server" Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="gvFiles_SelectedIndexChanged" DataKeyNames="Name">
                    ...
                    <ControlStyle ForeColor="Blue"></ControlStyle>
                        ...
                        <div>
                            <table>
                                <tr>
                                    <td colspan="3">
                                        <p class="contenthead">Memo History</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <asp:GridView ID="gvMemoHistory" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Width="100%">
         ...
         <div>
                            <table class="tablecss">
                                ...
                                <tr>
                                    <td>Subject</td>
                                    <td>
                                       <b> <asp:Label ID="vSubject" runat="server" Text=""></asp:Label></b>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:GridView ID="gvAttach" CellPadding="4" runat="server" Width="75%" AutoGenerateColumns="False" DataKeyNames="Name">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" HeaderText="File Name" />
                <asp:BoundField DataField="CreationTime" HeaderText="Attached Date" />
